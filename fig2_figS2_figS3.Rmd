...
``` {r}
#Add local path to downloaded data_tables from [https://ftp.ebi.ac.uk/pub/databases/cryptic/reproducibility/data_tables/cryptic-analysis-group/](http://ftp.ebi.ac.uk/pub/databases/cryptic/release_june2022/)
